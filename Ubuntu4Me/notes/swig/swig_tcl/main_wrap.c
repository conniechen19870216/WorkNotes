...
#define SWIG_init    Majun_Init
#define SWIG_name    "majun"
#define SWIG_prefix  ""
...
#endif
SWIGINTERN int
_wrap_kavon(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int arg2 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:kavon a b ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "kavon" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "kavon" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  result = (int)kavon(arg1,arg2);
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "kavon", (swig_wrapper_func) _wrap_kavon, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Majun_SafeInit(Tcl_Interp *interp) {
